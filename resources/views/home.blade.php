			...
			<div class="row w-100">
					<div class="col-md-3">
						<div class="card border-info mx-sm-1 p-3">
							...
							<div class="text-info text-center mt-2"><h1>15</h1></div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="card border-success mx-sm-1 p-3">
							...
							<div class="text-success text-center mt-2"><h1>2</h1></div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="card border-danger mx-sm-1 p-3">
							...
							<div class="text-danger text-center mt-3"><h4>Compras</h4></div>
							<div class="text-danger text-center mt-2"><h1>6</h1></div>
						</div>
					</div>
					<div class="col-md-3">
